...
public class MdmCitizenDataResourceIT {
    ...
    public void createMdmCitizenData() throws Exception {
        ...
        assertThat(testMdmCitizenData.getPersonId()).isEqualTo(DEFAULT_PERSON_ID);
    ...
    public void checkPersonIdIsRequired() throws Exception {
        ...
        // set the field null
        mdmCitizenData.setPersonId(null);
    ...
    public void updateMdmCitizenData() throws Exception {
        ...
        MdmCitizenData testMdmCitizenData = mdmCitizenDataList.get(mdmCitizenDataList.size() - 1);
        assertThat(testMdmCitizenData.getPersonId()).isEqualTo(UPDATED_PERSON_ID);
