...
public class MdmEmpRoleMasterResourceIT {
    ...
    public void createMdmEmpRoleMaster() throws Exception {
        ...
        assertThat(testMdmEmpRoleMaster.getEmployeeCode()).isEqualTo(DEFAULT_EMPLOYEE_CODE);
        assertThat(testMdmEmpRoleMaster.getEmployeeName()).isEqualTo(DEFAULT_EMPLOYEE_NAME);
        assertThat(testMdmEmpRoleMaster.getRoleCode()).isEqualTo(DEFAULT_ROLE_CODE);
        ...
        assertThat(testMdmEmpRoleMaster.getOrganizationCode()).isEqualTo(DEFAULT_ORGANIZATION_CODE);
    ...
    public void checkEmployeeCodeIsRequired() throws Exception {
        ...
        // set the field null
        mdmEmpRoleMaster.setEmployeeCode(null);
    ...
    public void checkRoleCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = mdmEmpRoleMasterRepository.findAll().size();
        // set the field null
        mdmEmpRoleMaster.setRoleCode(null);
    ...
    public void checkOrganizationCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = mdmEmpRoleMasterRepository.findAll().size();
        // set the field null
        mdmEmpRoleMaster.setOrganizationCode(null);
    ...
    public void updateMdmEmpRoleMaster() throws Exception {
        ...
        MdmEmpRoleMaster testMdmEmpRoleMaster = mdmEmpRoleMasterList.get(mdmEmpRoleMasterList.size() - 1);
        assertThat(testMdmEmpRoleMaster.getEmployeeCode()).isEqualTo(UPDATED_EMPLOYEE_CODE);
        assertThat(testMdmEmpRoleMaster.getEmployeeName()).isEqualTo(UPDATED_EMPLOYEE_NAME);
        assertThat(testMdmEmpRoleMaster.getRoleCode()).isEqualTo(UPDATED_ROLE_CODE);
        ...
        assertThat(testMdmEmpRoleMaster.getOrganizationCode()).isEqualTo(UPDATED_ORGANIZATION_CODE);
