...
public class MdmEmployeeMasterResourceIT {
    ...
    public void createMdmEmployeeMaster() throws Exception {
        ...
        assertThat(testMdmEmployeeMaster.getPersonId()).isEqualTo(DEFAULT_PERSON_ID);
        ...
        assertThat(testMdmEmployeeMaster.getOrganizationCode()).isEqualTo(DEFAULT_ORGANIZATION_CODE);
    ...
    public void updateMdmEmployeeMaster() throws Exception {
        ...
        assertThat(testMdmEmployeeMaster.getPersonId()).isEqualTo(UPDATED_PERSON_ID);
        ...
        assertThat(testMdmEmployeeMaster.getOrganizationCode()).isEqualTo(UPDATED_ORGANIZATION_CODE);
