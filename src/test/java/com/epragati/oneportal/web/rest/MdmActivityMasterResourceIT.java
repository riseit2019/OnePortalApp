...
public class MdmActivityMasterResourceIT {
    ...
    public void createMdmActivityMaster() throws Exception {
        ...
        assertThat(testMdmActivityMaster.getOrganizationCode()).isEqualTo(DEFAULT_ORGANIZATION_CODE);
    ...
    public void checkOrganizationCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = mdmActivityMasterRepository.findAll().size();
        // set the field null
        mdmActivityMaster.setOrganizationCode(null);
    ...
    public void updateMdmActivityMaster() throws Exception {
        ...
        assertThat(testMdmActivityMaster.getOrganizationCode()).isEqualTo(UPDATED_ORGANIZATION_CODE);
