package com.epragati.oneportal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.epragati.oneportal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.epragati.oneportal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
