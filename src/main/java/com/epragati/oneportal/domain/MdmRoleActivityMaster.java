...
public class MdmRoleActivityMaster implements Serializable {
    ...
    public MdmRoleActivityMaster activityCode(String activityCode) {
    ...
    public MdmRoleActivityMaster organizationCode(MdmOrganizationMaster mdmOrganizationMaster) {
