...
public class MdmMeesevaServiceMaster implements Serializable {
    ...
    @OneToOne(mappedBy = "meesevaServiceId")
    @JsonIgnore
    private MdmServiceMaster meesevaServiceId;
    ...
    public MdmMeesevaServiceMaster syspk(Long syspk) {
        this.syspk = syspk;
        return this;
    }
    ...
    public MdmServiceMaster getMeesevaServiceId() {
        return meesevaServiceId;
    }

    public MdmMeesevaServiceMaster meesevaServiceId(MdmServiceMaster mdmServiceMaster) {
        this.meesevaServiceId = mdmServiceMaster;
        return this;
    }

    public void setMeesevaServiceId(MdmServiceMaster mdmServiceMaster) {
        this.meesevaServiceId = mdmServiceMaster;
    }
