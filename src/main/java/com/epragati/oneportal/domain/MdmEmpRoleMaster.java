...
public class MdmEmpRoleMaster implements Serializable {
    ...
    public MdmEmpRoleMaster employeeCode(String employeeCode) {
    ...
    public MdmEmpRoleMaster roleCode(String roleCode) {
    ...
    public MdmEmpRoleMaster organizationCode(String organizationCode) {
