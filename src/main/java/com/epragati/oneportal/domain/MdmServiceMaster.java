...
public class MdmServiceMaster implements Serializable {
    ...
    @Column(name = "meeseva_service_id")
    ...
    public MdmServiceMaster organizationCode(String organizationCode) {
    ...
    public MdmServiceMaster meesevaServiceId(Integer meesevaServiceId) {
